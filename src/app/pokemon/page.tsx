...
export default function page() {
  ...
  useEffect(() => {
    ...
    const q = query(collection(db, 'cards'), where('title' , '==', 'Pokemon'));
  ...
  return (
      ...
      <main className="flex-1 p-6">
        ...
        <div className="flex justify-between items-center mb-6">
          <h1 className="text-3xl font-bold">Pokémon Cards</h1>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {pokemonCards.length > 0 ? (
            ...
            <p className="text-gray-600">No Pokémon cards found in the "Pokemon" category.</p>
          )}
        </div>
      </main>
    </div>
